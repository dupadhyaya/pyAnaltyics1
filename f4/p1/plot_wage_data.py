...
my_file = Path("./data/wages.txt")
if not my_file.is_file(): urllib.request.urlretrieve('http://lib.stat.cmu.edu/datasets/CPS_85_Wages','./data/wages.txt')
# download the file to data folder as wages2.txt
...
print(short_names)
data = pandas.read_csv('./data/wages.txt', skiprows=27, skipfooter=6, sep=None, header=None, engine='python')
print(data.columns)
